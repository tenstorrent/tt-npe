...
tt_npe::nocWorkload
genCongestedWorkload(const tt_npe::nocModel &model,
                      const std::unordered_map<std::string, float> &params) {
  tt_npe::nocWorkload wl;

...
TEST(npeWorkloadTest, CanRejectInvalidTransferSrc) {
    ...
    phase.transfers.push_back(
        npeWorkloadTransfer(2048, 1, {1, 100}, {1, 5}, 28.1, 0, nocType::NOC1));
    wl.addPhase(phase);
...
TEST(npeWorkloadTest, CanRejectInvalidTransferDst) {
    ...
    tt_npe::npeWorkloadPhase phase;
    phase.transfers.push_back(
        npeWorkloadTransfer(2048, 1, {1, 1}, {100, 5}, 28.1, 0, nocType::NOC1));
    wl.addPhase(phase);
...
TEST(npeWorkloadTest, CanRejectInvalidNumPackets) {
    tt_npe::npeWorkload wl;
    tt_npe::npeWorkloadPhase phase;
    phase.transfers.push_back(npeWorkloadTransfer(2048, 0, {1, 1}, {1, 5}, 28.1, 0, nocType::NOC1));
    wl.addPhase(phase);
...
TEST(npeWorkloadTest, CanRejectInvalidPacketSize) {
    tt_npe::npeWorkload wl;
    tt_npe::npeWorkloadPhase phase;
    phase.transfers.push_back(npeWorkloadTransfer(0, 1, {1, 1}, {1, 5}, 28.1, 0, nocType::NOC1));
    wl.addPhase(phase);

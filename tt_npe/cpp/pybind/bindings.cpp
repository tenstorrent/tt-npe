...
PYBIND11_MODULE(tt_npe_pybind, m) {
    ...
    py::class_<tt_npe::npeConfig>(
        ...
        .def_readwrite("exp_wh_noc_topo_override", &tt_npe::npeConfig::exp_wh_noc_topo_override)
        .def_readwrite("exp_wh_noc_bw_multiplier", &tt_npe::npeConfig::exp_wh_noc_bw_multiplier)
